...
Finalmente se construye el objeto de DESeqDataSet con la función DESeq para poder realizar el análisis de expresión diferencial posteriormente. Por otra parte, se guardan las cuentas normalizadas por si fueran necesarias para procesos downstream.
...
file <- paste0(resD, "deseq2_sig_padj_", suffix, ".tsv", sep="")
